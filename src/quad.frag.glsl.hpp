...
"p=vec4(mix(mix(m,vec3(1),pow(max(dot(o,i),.0),7.)),r,n),1.)-(int(gl_FragCoord.g*.5)%2+.1)*(max(max(smoothstep(.98,1.,e[7].g),smoothstep(-.02*e[9].r,.0,-e[7].g)*e[9].r),.1)+g*.02)*dot(s,s);"
"t=c;"
"v=d(t,o,e[8],g+.2);"
